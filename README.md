...
| ------------- | ------------- | ----- |
| [React-pizza](https://github.com/Doc-Kristen/react-pizza) | Демо-версия сайта пиццерии. Репозиторий создан с целью целью попрактиковаться, поэкспериментировать. [Демонстрация](https://master--frolicking-rugelach-e30ac6.netlify.app/)|TypeScript, React, Redux Toolkit|
